...
export default function Image() {
  return (
      <div className="position-relative mx-5 py-5" style={{ width: '20%' }}> {/*just edit this line don't remove position-relative class else you can*/}
        <div className='position-absolute d-flex flex-column align-items-center' style={{ top: 0, bottom: 0, left: '25%', right: '25%' }}>
          <h6 className='logoText vw-50'>Been There</h6>
